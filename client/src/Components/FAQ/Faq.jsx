      ...
      <div className="faq-list">
        ...
        <div className="faq-item-left">
          ...
          {expandedItems.includes(0) ? (
            <AiOutlineMinus className="faq-icon" onClick={() => handleToggle(0)} />
          ) : (
            <AiOutlinePlus className="faq-icon" onClick={() => handleToggle(0)} />
          )}
          {expandedItems.includes(0) && (
        ...
        <div className="faq-item-left">
          ...
          {expandedItems.includes(1) ? (
            <AiOutlineMinus className="faq-icon" onClick={() => handleToggle(1)} />
          ) : (
            <AiOutlinePlus className="faq-icon" onClick={() => handleToggle(1)} />
          )}
          {expandedItems.includes(1) && (
            <div className="faq-answer">
              <p>
        ...
        <div className="faq-item-left">
          ...
          {expandedItems.includes(2) ? (
            <AiOutlineMinus className="faq-icon" onClick={() => handleToggle(2)} />
          ) : (
            <AiOutlinePlus className="faq-icon" onClick={() => handleToggle(2)} />
          )}
          {expandedItems.includes(2) && (
            <div className="faq-answer">
              <p>
        ...
        <div className="faq-item-right">
          ...
          {expandedItems.includes(3) ? (
            <AiOutlineMinus className="faq-icon" onClick={() => handleToggle(3)} />
          ) : (
            <AiOutlinePlus className="faq-icon" onClick={() => handleToggle(3)} />
          )}
          {expandedItems.includes(3) && (
            <div className="faq-answer">
              <p>
        ...
        <div className="faq-item-right">
          ...
          {expandedItems.includes(4) ? (
            <AiOutlineMinus className="faq-icon" onClick={() => handleToggle(4)} />
          ) : (
            <AiOutlinePlus className="faq-icon" onClick={() => handleToggle(4)} />
          )}
          {expandedItems.includes(4) && (
            <div className="faq-answer">
              <p>
        ...
        <div className="faq-item-right">
          ...
          {expandedItems.includes(5) ? (
            <AiOutlineMinus className="faq-icon" onClick={() => handleToggle(5)} />
          ) : (
            <AiOutlinePlus className="faq-icon" onClick={() => handleToggle(5)} />
          )}
          {expandedItems.includes(5) && (
            <div className="faq-answer">
              <p>
