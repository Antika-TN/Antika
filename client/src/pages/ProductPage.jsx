  ...
  return (
    <div>
      ...
      <div className="ProfilePic" style={{ width: 120, height: 124, left: 460, top: 285, position: 'absolute' }}>
        <img className="Ellipse251" style={{ width: 120, height: 120, left: 200, top: 150, position: 'absolute', borderRadius: '50%', border: '1.50px white solid' }} src="https://via.placeholder.com/120x120" alt="Profile" />
      ...
      <div className="Text" style={{ width: 896, height: 115, left: 71, top: 427, position: 'absolute' }}>
        <div className="FarhanKhan" style={{ left: 572, top: 144, position: 'absolute', color: 'white', fontSize: 28, fontFamily: 'SF Pro Display', fontWeight: '600', wordWrap: 'break-word' }}>Farhan Khan</div>
      ...
      <div className="PhotosSec" style={{ width: 345, height: 371, left: 200, top: 771, position: 'absolute' }}>
        ...
        <img className="Rectangle1906" style={{ width: 95, height: 91, left: 20, top: 65, position: 'absolute', borderRadius: 4 }} src="https://via.placeholder.com/95x91" alt="Photo" />
        <img className="Rectangle1909" style={{ width: 95, height: 91, left: 20, top: 166, position: 'absolute', borderRadius: 4 }} src="https://via.placeholder.com/95x91" alt="Photo" />
        <img className="Rectangle1912" style={{ width: 95, height: 91, left: 20, top: 267, position: 'absolute', borderRadius: 4 }} src="https://via.placeholder.com/95x91" alt="Photo" />
        <img className="Rectangle1907" style={{ width: 95, height: 91, left: 125, top: 65, position: 'absolute', borderRadius: 4 }} src="https://via.placeholder.com/95x91" alt="Photo" />
        <img className="Rectangle1910" style={{ width: 95, height: 91, left: 125, top: 166, position: 'absolute', borderRadius: 4 }} src="https://via.placeholder.com/95x91" alt="Photo" />
        <img className="Rectangle1913" style={{ width: 95, height: 91, left: 125, top: 267, position: 'absolute', borderRadius: 4 }} src="https://via.placeholder.com/95x91" alt="Photo" />
        <img className="Rectangle1908" style={{ width: 95, height: 91, left: 230, top: 65, position: 'absolute', borderRadius: 4 }} src="https://via.placeholder.com/95x91" alt="Photo" />
        <img className="Rectangle1911" style={{ width: 95, height: 91, left: 230, top: 166, position: 'absolute', borderRadius: 4 }} src="https://via.placeholder.com/95x91" alt="Photo" />
      </div>
      <div className="FeedSec1" style={{ width: 666, height: 532, left: 575, top: 769, position: 'absolute' }}>
        <img className="Ellipse248" style={{ width: 43, height: 43, left: 0, top: 0, position: 'absolute', borderRadius: '50%' }} src="https://via.placeholder.com/43x43" alt="Profile" />
        ...
        <img className="Rectangle1901" style={{ width: 666, height: 426, left: 0, top: 106, position: 'absolute', borderRadius: 5 }} src="https://via.placeholder.com/666x426" alt="Feed" />
      </div>
    </div>
  );
};
