  ...
  return (
    <div>
      ...
      <div className="ProfilePic" style={{ width: 120, height: 124, left: 460, top: 285, position: 'absolute' }}>
        <img className="Ellipse251" style={{ width: 120, height: 120, left: 200, top: 150, position: 'absolute', borderRadius: 9999, border: '1.50px white solid' }} src="https://via.placeholder.com/120x120" />
        <div className="Ellipse252" style={{ width: 31, height: 31, left: 294, top: 230, position: 'absolute', background: '#6C5DD3', borderRadius: 9999 }}></div>
